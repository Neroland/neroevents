...
All notable changes to **NeroEvents** are documented in this file.
...
- **EMI support.** NeroEvents adds no recipes of its own, so nothing needed a plugin. The build now
